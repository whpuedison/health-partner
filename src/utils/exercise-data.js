...
const exerciseCategories = [
  {
    ...
    exercises: [
      ...
      { id: 'pilates', name: '普拉提', icon: '🤸', calories: 4, intensity: '低' },
      ...
      { id: 'soccer', name: '足球', icon: '⚽', calories: 9, intensity: '高' }
    ]
  },
  {
    id: 'daily',
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'sit_up', name: '仰卧起坐', icon: '🧘', calories: 4, intensity: '中' },
      { id: 'squat', name: '深蹲', icon: '🏋️', calories: 6, intensity: '高' },
      { id: 'pull_up', name: '引体向上', icon: '🤸', calories: 8, intensity: '高' },
      { id: 'weightlifting', name: '举重', icon: '🏋️‍♂️', calories: 6, intensity: '高' },
      { id: 'dumbbell', name: '哑铃训练', icon: '🦾', calories: 5, intensity: '中' },
      { id: 'bench_press', name: '卧推', icon: '🏋️', calories: 5, intensity: '中' },
      { id: 'plank', name: '平板支撑', icon: '📏', calories: 4, intensity: '中' },
